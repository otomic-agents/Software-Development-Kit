...
import { _getRefundSwapTransaction, getJsonRpcProvider } from '../../business/solana';
import { PreBusiness, NetworkType } from '../../interface/interface';
import { ResponseSolana } from '../../interface/api';

export const _refundSwapByWalletPlugin = (
    ...
    new Promise<ResponseSolana>(async (resolve, reject) => {
        try {
            ...
            //transfer out
            let tx = await _getRefundSwapTransaction(preBusiness, provider, network);
