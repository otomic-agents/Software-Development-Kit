...
export const _getComplainSignData = (preBusiness: PreBusiness, network: NetworkType): ComplainSignData => {
    ...
    const complaintValue: ComplaintValue = {
        ...
        expectedSingleStepTime: preBusiness.swap_asset_information.expected_single_step_time || 0,
        tolerantSingleStepTime: preBusiness.swap_asset_information.tolerant_single_step_time || 0,
